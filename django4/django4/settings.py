...
SECRET_KEY = 'django-insecure-tt5!fzk_ut-nd$-&j(s8h&9(td^rv(@g6h@2x)detmkn5**gu%'
...
INSTALLED_APPS = [
    ...
    'django_extensions',
    'help_test',
    'simple_site.apps.SimpleSiteConfig',
    'getlink_app.apps.GetlinkAppConfig',
    'test_slug.apps.TestSlugConfig',
    'info_notes1.apps.InfoNotes1Config',
